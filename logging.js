...
// docs.google.com/forms/d/e/1FAIpQLSeptWnNx_TX80AY_Xmeo_R-T1UWtPbazfcUglBjWGto_wvdUw/viewform
function sendNetworkLog(
    ...
    state,
    log_version) {
  var formid = "e/1FAIpQLSeptWnNx_TX80AY_Xmeo_R-T1UWtPbazfcUglBjWGto_wvdUw";
  var data = {
    "entry.1935316836": uid,
    "entry.1776208185": time,
    "entry.369189784": eventname,
    "entry.148083265": target,
    "entry.921649272": info,
    "entry.1461565552": state,
    "entry.1045005429": log_version
  };
  var params = [];
  for (key in data) {
